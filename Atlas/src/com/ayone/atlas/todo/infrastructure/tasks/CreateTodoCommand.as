...
[Bindable]
public class CreateTodoCommand implements ICommand, ICreateTodoCommand
{
	//------------------------------------------------------------
	//
	// Properties
	...
	{		
		...
		service.createTodo.addEventListener("result", createTodoResultHandler);
		service.addEventListener("fault", faultHandler);
		service.createTodo(manager.project.id, title);
	}
	...
	private function createTodoResultHandler(e:ResultEvent):void 
	{
		manager.todoItems.addItem(ToDoItem(e.result));
